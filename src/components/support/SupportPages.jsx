...
export const SupportPrivacy = () => (
  <div>
    ...
    <p className="support-body">
      ...
      доставки, клиентской поддержки, а также защиты сайта от спама и злоупотреблений. Сайт Mardan не
      подключён к сервисам аналитики или рекламным пикселям, и мы не используем ваши данные для рекламного
      таргетинга.
    </p>
    <p className="support-body">
      Если при оформлении заказа вы отдельно отметили согласие на рассылку — мы также используем ваш email
      и/или WhatsApp, чтобы сообщать о новых коллекциях, акциях и специальных предложениях. Такая рассылка
      отправляется только с вашего явного согласия, и вы можете отозвать его в любой момент, написав нам на{" "}
